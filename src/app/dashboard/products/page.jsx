...
export default function Products() {
  ...
  const handleClose = (id) => {
    deleteProduct(id)
      .then(() => {
        setAlert({ active: true, message: 'Delete product successfully', type: 'success', autoClose: true });
      })
      .catch((error) => {
        setAlert({ active: true, message: error.message, type: 'error', autoClose: true });
      });
  };
